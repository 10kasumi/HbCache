...
public class ExistMessageHandler extends SimpleChannelInboundHandler<ExistMessage> {
    @Override
    protected void channelRead0(ChannelHandlerContext ctx, ExistMessage msg) throws Exception {
