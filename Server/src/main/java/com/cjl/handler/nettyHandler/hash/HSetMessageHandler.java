...
public class HSetMessageHandler extends SimpleChannelInboundHandler<HSetMessage> {
    @Override
    protected void channelRead0(ChannelHandlerContext ctx, HSetMessage msg) throws Exception {
