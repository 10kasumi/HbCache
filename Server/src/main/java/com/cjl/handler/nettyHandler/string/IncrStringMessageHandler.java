...
public class IncrStringMessageHandler extends SimpleChannelInboundHandler<IncrStringMessage> {
    @Override
    protected void channelRead0(ChannelHandlerContext ctx, IncrStringMessage msg) throws Exception {
