...
public class SAddMessageHandler extends SimpleChannelInboundHandler<SAddMessage> {
    @Override
    protected void channelRead0(ChannelHandlerContext ctx, SAddMessage msg) throws Exception {
