...
public class SetExStringMessageHandler extends SimpleChannelInboundHandler<SetExStringMessage> {
    @Override
    protected void channelRead0(ChannelHandlerContext ctx, SetExStringMessage msg) throws Exception {
