...
public class SetStringMessageHandler extends SimpleChannelInboundHandler<SetStringMessage> {
    @Override
    protected void channelRead0(ChannelHandlerContext ctx, SetStringMessage msg) throws Exception {
