...
public class HSetNxMessageHandler extends SimpleChannelInboundHandler<HSetNxMessage> {

    @Override
    protected void channelRead0(ChannelHandlerContext ctx, HSetNxMessage msg) throws Exception {
