...
public class BLpopMessageHandler extends SimpleChannelInboundHandler<BLpopMessage> {
    @Override
    protected void channelRead0(ChannelHandlerContext ctx, BLpopMessage msg) throws Exception {
