...
public class ExpireMessageHandler extends SimpleChannelInboundHandler<ExpireMessage> {
    @Override
    protected void channelRead0(ChannelHandlerContext ctx, ExpireMessage msg) throws Exception {
