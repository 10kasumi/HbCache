...
public class BRpopMessageHandler extends SimpleChannelInboundHandler<BRpopMessage> {
    @Override
    protected void channelRead0(ChannelHandlerContext ctx, BRpopMessage msg) throws Exception {
