...
public class SIsMemberMessageHandler extends SimpleChannelInboundHandler<SIsMemberMessage> {

    @Override
    protected void channelRead0(ChannelHandlerContext ctx, SIsMemberMessage msg) throws Exception {
