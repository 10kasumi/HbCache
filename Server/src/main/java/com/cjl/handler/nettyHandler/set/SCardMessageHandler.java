...
public class SCardMessageHandler extends SimpleChannelInboundHandler<SCardMessage> {
    @Override
    protected void channelRead0(ChannelHandlerContext ctx, SCardMessage msg) throws Exception {
