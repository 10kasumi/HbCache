...
public class HKeysMessageHandler extends SimpleChannelInboundHandler<HKeysMessage> {

    @Override
    protected void channelRead0(ChannelHandlerContext ctx, HKeysMessage msg) throws Exception {
