...
public class HGetMessageHandler extends SimpleChannelInboundHandler<HGetMessage> {

    @Override
    protected void channelRead0(ChannelHandlerContext ctx, HGetMessage msg) throws Exception {
