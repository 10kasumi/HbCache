...
public class IncrByStringMessageHandler extends SimpleChannelInboundHandler<IncrByStringMessage> {
    @Override
    protected void channelRead0(ChannelHandlerContext ctx, IncrByStringMessage msg) throws Exception {
