...
public class RPopMessageHandler extends SimpleChannelInboundHandler<RPopMessage> {
    @Override
    protected void channelRead0(ChannelHandlerContext ctx, RPopMessage msg) throws Exception {
