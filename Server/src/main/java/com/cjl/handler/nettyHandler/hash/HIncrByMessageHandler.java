...
public class HIncrByMessageHandler extends SimpleChannelInboundHandler<HIncrByMessage> {
    @Override
    protected void channelRead0(ChannelHandlerContext ctx, HIncrByMessage msg) throws Exception {
