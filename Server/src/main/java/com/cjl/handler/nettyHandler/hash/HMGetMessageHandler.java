...
public class HMGetMessageHandler extends SimpleChannelInboundHandler<HMGetMessage> {
    @Override
    protected void channelRead0(ChannelHandlerContext ctx, HMGetMessage msg) throws Exception {
