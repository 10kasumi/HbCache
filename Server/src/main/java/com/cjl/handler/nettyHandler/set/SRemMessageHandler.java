...
public class SRemMessageHandler extends SimpleChannelInboundHandler<SRemMessage> {
    @Override
    protected void channelRead0(ChannelHandlerContext ctx, SRemMessage msg) throws Exception {
