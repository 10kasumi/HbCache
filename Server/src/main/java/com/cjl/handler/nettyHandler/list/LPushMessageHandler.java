...
public class LPushMessageHandler extends SimpleChannelInboundHandler<LPushMessage> {
    @Override
    protected void channelRead0(ChannelHandlerContext ctx, LPushMessage msg) throws Exception {
